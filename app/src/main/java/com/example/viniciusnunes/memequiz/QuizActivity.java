    ...
    List<Questao> questoes = new ArrayList<Questao>(){
        {
            ...
            add(new Questao(R.drawable.jesus, "A missionária estava pregando sua palavra e disse que:", R.id.rbResposta3, "Sem Jesus não viverão!", "Jesus é bom o tempo todo", "O sangue de Jesus tem poder!", "O sangue de Jesus é maravilhosooooo!"));
